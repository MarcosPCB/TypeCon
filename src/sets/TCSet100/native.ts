...
export interface CON_NATIVE_FUNCTION {
    ...
    arg_fp_bits?: (11 | 14 | 16 | 30 | 0)[],  // expected FP precision per argument (for float literal auto-conversion)
    returnable?: any,
    return_size?: number,
...
setarray nwsCurrAmmo[flat[rbp]] ra`;
    ...
    { name: 'fp11ToInt', code: (_a?: boolean) => `set rb r0\nshiftr rb 11`, returns: true, return_type: 'variable', arg_fp_bits: [11], arguments: [CON_NATIVE_FLAGS.VARIABLE] },
    { name: 'fp14ToInt', code: (_a?: boolean) => `set rb r0\nshiftr rb 14`, returns: true, return_type: 'variable', arg_fp_bits: [14], arguments: [CON_NATIVE_FLAGS.VARIABLE] },
    { name: 'fp16ToInt', code: (_a?: boolean) => `set rb r0\nshiftr rb 16`, returns: true, return_type: 'variable', arg_fp_bits: [16], arguments: [CON_NATIVE_FLAGS.VARIABLE] },
    { name: 'fp30ToInt', code: (_a?: boolean) => `set rb r0\nshiftr rb 30`, returns: true, return_type: 'variable', arg_fp_bits: [30], arguments: [CON_NATIVE_FLAGS.VARIABLE] },
    { name: 'fp11Raw', code: (_a?: boolean) => `set rb r0`, returns: true, return_type: 'variable', arg_fp_bits: [11], arguments: [CON_NATIVE_FLAGS.VARIABLE] },
    { name: 'fp14Raw', code: (_a?: boolean) => `set rb r0`, returns: true, return_type: 'variable', arg_fp_bits: [14], arguments: [CON_NATIVE_FLAGS.VARIABLE] },
    { name: 'fp16Raw', code: (_a?: boolean) => `set rb r0`, returns: true, return_type: 'variable', arg_fp_bits: [16], arguments: [CON_NATIVE_FLAGS.VARIABLE] },
    { name: 'fp30Raw', code: (_a?: boolean) => `set rb r0`, returns: true, return_type: 'variable', arg_fp_bits: [30], arguments: [CON_NATIVE_FLAGS.VARIABLE] },
    { name: 'fp11ToString', code: (_a?: boolean) => `state _convertFP11ToString`, returns: true, return_type: 'string', arg_fp_bits: [11], arguments: [CON_NATIVE_FLAGS.VARIABLE] },
    { name: 'fp14ToString', code: (_a?: boolean) => `state _convertFP14ToString`, returns: true, return_type: 'string', arg_fp_bits: [14], arguments: [CON_NATIVE_FLAGS.VARIABLE] },
    { name: 'fp16ToString', code: (_a?: boolean) => `state _convertFP2String`, returns: true, return_type: 'string', arg_fp_bits: [16], arguments: [CON_NATIVE_FLAGS.VARIABLE] },
    { name: 'fp30ToString', code: (_a?: boolean) => `state _convertFP30ToString`, returns: true, return_type: 'string', arg_fp_bits: [30], arguments: [CON_NATIVE_FLAGS.VARIABLE] },
    ...
    { name: 'fromCharCode', code: (_a?: boolean) => `state pushr2\nset r0 2\nset r1 2\nstate alloc\nstate popr2\nsetarray flat[rb] 1\n add rb 1\nsetarray flat[rb] r0\nsub rb 1\n`, returns: true, return_type: 'string', arguments: [CON_NATIVE_FLAGS.VARIABLE] },
    ...
    { name: 'checkFpEq', code: (_a?: boolean) => `state _checkFpEq`, returns: false, return_type: null, arg_fp_bits: [0, 16, 16], arguments: [CON_NATIVE_FLAGS.VARIABLE, CON_NATIVE_FLAGS.VARIABLE, CON_NATIVE_FLAGS.VARIABLE] },
