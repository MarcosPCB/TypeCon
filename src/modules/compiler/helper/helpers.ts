...
export function evaluateLiteralExpression(
  ...
  export function findNativeFunction(fnName: string, obj?: string, type?: string): CON_NATIVE_FUNCTION | undefined {
    ...
    return nativeFunctions.find(nf => (nf.name == cleanName && ((obj && nf.object_belong && nf.object_belong.includes(obj) || (obj && type && nf.type_belong && nf.type_belong.includes(type))) || (!obj && !nf.type_belong && !nf.object_belong))));
  }
