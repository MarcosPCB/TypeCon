...
class TestAnim extends CEvent {
    ...
    public Append(): void {
        ...
        checkFpEq("easeInSine(0.5)", 19196, AnimUtils.easeInSine(t));
        checkFpEq("easeOutSine(0.5)", 46340, AnimUtils.easeOutSine(t));
        ...
        checkFpEq("oscillateFP(100,60)", 21845, AnimUtils.oscillateFP(100, 60));
